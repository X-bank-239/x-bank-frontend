...
export function TopNav() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-md">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6">
        ...
        <Link href="/dashboard" className="flex items-center gap-2 shrink-0">
          ...
          <span className="hidden text-[15px] font-semibold text-slate-800 dark:text-slate-100 sm:inline">
            X-Bank
          </span>
        </Link>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2 rounded-xl px-2.5 py-2 hover:bg-slate-100 dark:hover:bg-slate-800 min-w-0"
      ...
      {menuOpen && (
        <>
          ...
          />
          <div className="fixed inset-y-0 right-0 z-[70] w-full max-w-xs bg-white dark:bg-slate-900 shadow-2xl ring-1 ring-black/5 md:hidden opacity-100">
